					...
					<div class="mx-auto text-center">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li><a href="<c:url value='/admin/list-student' />">List Students</a></li>
						...
						<div class="col-12">
							<div class="row align-items-center">
								...
								<div class="col-lg-5 ml-auto" data-aos="fade-up"
									data-aos-delay="500">
									<c:url value="/admin/details" var="url" />
									<form:form modelAttribute="user" method="post" action="${url }"
										class="form-box">
									<form:form >
										<h2>User Info</h2>
										<p style="color: gray;">Name: ${user.name }</p>
										<p style="color: gray;">Telephone number:
											${user.telephonr_number }</p>
										<p style="color: gray;">Id: ${user.id }</p>
										<p style="color: gray;">Date of birth:
											${user.dateOfBirth }</p>
										<p style="color: gray;">Email address: ${user.email }</p>
										<p style="color: gray;">Gender: ${user.gender }</p>
									</form:form>
									</form:form>
