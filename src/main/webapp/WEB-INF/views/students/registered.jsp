	...
	<div class="site-wrap">
					...
					<div class="mx-auto text-center">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li><a href="<c:url value = '/details' />" class="nav-link">Info</a></li>
					...
					<div class="ml-auto w-25">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li class="cta"><a href="<c:url value='/home' />"><span>Log out</span></a></li>
							</ul>
						</nav>
						<a href="#"
							...
							<div class="row align-items-center">
								...
								<%-- <div class="col-lg-5 ml-auto" data-aos="fade-up"
									...
									<form action="" method="post" class="form-box">
										...
										<div class="form-group">
											<label for="telephonr_number">Telephone number</label> <input
				...
				<div class="row">
					...
					<div class="owl-carousel col-12 nonloop-block-14">
						...
						<div class="course bg-white h-100 align-self-stretch">
							<figure class="m-0">
								<a href="course-single.html"><img
									src="<c:url value='/rs/images/img_1.jpg'/>" alt="Image"
									class="img-fluid"></a>
							</figure>
						...
						<div class="course bg-white h-100 align-self-stretch">
							<figure class="m-0">
								<a href="course-single.html"><img
									src="<c:url value='/rs/images/img_2.jpg'/>" alt="Image"
									class="img-fluid"></a>
							</figure>
							<div class="course-inner-text py-4 px-4">
						...
						<div class="course bg-white h-100 align-self-stretch">
							<figure class="m-0">
								<a href="course-single.html"><img
									src="<c:url value='rs/images/img_3.jpg'/>" alt="Image"
									class="img-fluid"></a>
							</figure>
							<div class="course-inner-text py-4 px-4">
								<span class="course-price">$99</span>
						...
						<div class="course bg-white h-100 align-self-stretch">
							<figure class="m-0">
								<a href="course-single.html"><img
									src="<c:url value='/rs/images/img_4.jpg'/>" alt="Image"
									class="img-fluid"></a>
							</figure>
							<div class="course-inner-text py-4 px-4">
								<span class="course-price">$20</span>
						...
						<div class="course bg-white h-100 align-self-stretch">
							<figure class="m-0">
								<a href="course-single.html"><img
									src="<c:url value='/rs/images/img_5.jpg'/>" alt="Image"
									class="img-fluid"></a>
							</figure>
							<div class="course-inner-text py-4 px-4">
								<span class="course-price">$99</span>
						...
						<div class="course bg-white h-100 align-self-stretch">
							<figure class="m-0">
								<a href="course-single.html"><img
									src="<c:url value='/rs/images/img_6.jpg'/>" alt="Image"
									class="img-fluid"></a>
							</figure>
							<div class="course-inner-text py-4 px-4">
								<span class="course-price">$99</span>
			...
			<div class="container">
				...
				<div class="row mb-5 align-items-center">
					<div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
						<img src="<c:url value='/rs/images/undraw_youtube_tutorial.svg'/>"
				...
				<div class="row mb-5 align-items-center">
					<div class="col-lg-7 mb-5 order-1 order-lg-2" data-aos="fade-up"
						data-aos-delay="100">
						<img src="<c:url value='/rs/images/undraw_teaching.svg'/>"
							alt="Image" class="img-fluid">
					</div>
				...
				<div class="row mb-5 align-items-center">
					<div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
						<img
							src="<c:url value='/rs/images/undraw_teacher.svg" alt="Image'/>"
							alt="Image" class="img-fluid">
					</div>
					<div class="col-lg-4 ml-auto" data-aos="fade-up"
						data-aos-delay="200">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up"
						...
						<div class="teacher text-center">
							<img src="<c:url value='/rs/images/person_1.jpg'/>" alt="Image"
					...
					<div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up"
						data-aos-delay="200">
						<div class="teacher text-center">
							<img src="<c:url value='/rs/images/person_2.jpg'/>" alt="Image"
								class="img-fluid w-50 rounded-circle mx-auto mb-4">
							<div class="py-2">
					...
					<div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up"
						data-aos-delay="300">
						<div class="teacher text-center">
							<img src="<c:url value='/rs/images/person_3.jpg'/>" alt="Image"
								class="img-fluid w-50 rounded-circle mx-auto mb-4">
							<div class="py-2">
			...
			<div class="container">
				<div class="row justify-content-center align-items-center">
					<div class="col-md-8 text-center testimony">
						<img src="<c:url value='/rs/images/person_4.jpg'/>" alt="Image"
							class="img-fluid w-25 rounded-circle mx-auto mb-4">
		...
		<div class="site-section pb-0">
			...
			<div class="future-blobs">
				<div class="blob_2">
					<img src="<c:url value='/rs/images/blob_2.svg'/>" alt="Image">
				</div>
				<div class="blob_1">
					<img src="<c:url value='/rs/images/blob_1.svg'/>" alt="Image">
				</div>
			</div>
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-7 align-self-end" data-aos="fade-left"
						data-aos-delay="200">
						<img src="<c:url value='/rs/images/person_transparent.png'/>"
							alt="Image" class="img-fluid">
					</div>
				</div>
			</div>
